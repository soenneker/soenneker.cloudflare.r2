...
{
    public async ValueTask<R2GetBucketCorsPolicy200?> GetCorsPolicy(string accountId, string bucketName, string? apiKey = null, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<R2DeleteBucketCorsPolicy200?> DeleteCorsPolicy(string accountId, string bucketName, string? apiKey = null, CancellationToken cancellationToken = default)
    {
        CloudflareOpenApiClient client = await GetClient(apiKey, cancellationToken).NoSync();
